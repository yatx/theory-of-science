...
Der Satz vom gedoppelten Mittelpunkt lässt sich an einer einfachen Gestalt nachprüfen. Man nehme eine offene Strecke: zwei Enden, die nicht dazugehören, und eine Mitte, die dazugehört. Die Enden seien die Pole, die Mitte der Indifferenzpunkt, und jeder Punkt dazwischen habe einen Anteil an beiden Seiten, so dass die Differenz, wie Hegel sagt, nur quantitativ ist. Teilt man die Strecke in der Mitte, so ist jede Hälfte wieder eine offene Strecke mit zwei Enden und eigener Mitte, und dasselbe gilt für jeden Teil jedes Teils. Jeder Teil ist dem Ganzen der Gestalt nach gleich, ohne verkleinert zu sein; jede Strecke lässt sich durch eine einfache Dehnung auf jede andere legen, Enden auf Enden, Mitte auf Mitte. Das ist die Teilung ins Unendliche als Figur.

Der Mittelpunkt ist in dieser Figur gedoppelt, und zwar genau so, wie der Satz es verlangt. Jeder Teil hat seine eigene Mitte, und sie liegt in seinem Inneren. Die Mitte des Ganzen aber liegt auf keiner Stufe der Teilung im Inneren eines Teils; sie ist stets nur Rand, und zwar Rand von genau zwei Teilen. Als Identität liegt der Indifferenzpunkt überall in den Teilen, als absolute Totalität außer ihnen (Abbildung~\ref{fig:strecke}). Die Figur zeigt zugleich, was Fichtes Setzung des Selbstbewusstseins als des Absoluten ist. Der Pol allein ist ein Punkt: ohne Inneres, ohne Mitte, ohne Teile. Wer ihn als das Ganze nimmt, nimmt einen Rand für den Raum, den er begrenzt. Das subjektive \SO{} hingegen ist die Hälfte, die diesen Pol als Rand hat; sie hat ihre eigene Mitte und ist darum selbst eine Identität von Subjekt und Objekt. Der Unterschied zwischen Fichtes Ich und dem subjektiven \SO{} ist der Unterschied zwischen dem Endpunkt und der Strecke, die in ihm endet.
...
Die Formulierung vom Gebären hat eine Herkunft, die Hegel in der Vergleichung selbst nennt: Kant stelle die Natur als ein \SO{} dar, indem er das Naturprodukt als Naturzweck betrachte \Werke{103}. Kant bestimmt ein organisiertes Wesen durch ein doppeltes Verhältnis. Die Teile sind nur durch ihre Beziehung auf das Ganze möglich; und die Teile bringen einander und das Ganze wechselseitig hervor, jeder Teil ist Ursache und Wirkung der anderen. Ein Uhrwerk erfüllt nur das erste, denn seine Räder sind für das Ganze da, aber kein Rad erzeugt ein anderes; ein Lebewesen erfüllt beides. Kant hält dieses Verhältnis für eine Maxime der Urteilskraft, nach der wir die Natur beurteilen dürfen, nicht für ein Prinzip der Natur selbst. Hegels Satz, das Absolute gebäre beide und gebäre sich aus beiden, ist diese Bestimmung des Organismus, aus dem Als-ob in das Sein versetzt und vom Lebewesen auf das Ganze übertragen. Darum kann jeder Staub eine Organisation sein: Ist das Ganze ein Organismus, so ist jeder Teil, weil er das Ganze in sich hat, wieder einer. Und darum ist die Zusammensetzung keine aus Stücken. Stücke liegen nebeneinander und bringen einander nicht hervor; Organe bringen einander hervor, und ihre Einheit ist das Leben, das in jedem von ihnen ganz ist. Die Formel der Identität der Identität und der Nichtidentität wird von hier aus lesbar als die Logik des Organismus: Die Organe sind verschieden, das Leben ist eines, und diese Einheit bewahrt die Verschiedenheit, weil die Teile gerade durch sie einander hervorbringen.
...
Die offene Strecke mit gedoppeltem Mittelpunkt bildet die Struktur von S.~111 ab: eigene Mitte in jedem Teil, Mitte des Ganzen nur Rand. & Deutung, rechnerisch geprüft & W~2, S.~96~f., 111 \\
Der Satz vom Gebären hat seine Herkunft in Kants Bestimmung des Naturzwecks. & Deutung, gestützt & W~2, S.~103 \\
...
\item Abbildung~\ref{fig:strecke}: Die offene Strecke und ihre Teilungen; die eigene Mitte jedes Teils und die Mitte des Ganzen als bloßer Rand.
...
\item Datei: subjekt-objekt\_identitaet\_der\_identitaet\_v2.tex
\item Version: v2 (v1 in versionen/)
...
\item Status: Zweitfassung; eingewoben aus der Reflexion vom 2026-09-25 (Streckenmodell, Kantische Herkunft des Gebären-Satzes); Kanon nach Pauschale, solange die Qualität hält
\end{itemize}
