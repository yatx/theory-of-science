...
\item Belegt: Die Zeit ist der wahrhafte Punkt; der Punkt hat im Raum keine Wirklichkeit (Hegel, Nachschrift).
\item Belegt: Auch die Zeitfolge beruht auf einer topologischen Zuordnungsdefinition; die Raumordnung wird an den Kausalketten definiert (Reichenbach, \S\,21, \S\,42, \S\,44).
...
\item Belegt: Der Raum setzt die Zeit voraus und ist nur als Zeitraum konzipierbar (Brandt, von Martić übernommen); die Zeit wird nur am Raum zur Größe (Martić, zu Kant).
\item Belegt: Um die Zukunft zu erfahren, muss man nur warten; für die Vergangenheit gilt das nicht (Chiba). Die Wendung auf den Raum ist eigene Folgerung.
...
\item Erschlossen: Der Ort als ein als Jetzt gesetzter Punkt; Lesart von Hegels Übergang, kein Wortlaut.
\item Erschlossen: Das weltweite Jetzt, sofern es bestimmbar sein soll, ist die Gleichzeitigkeit und damit Definition; Finks Jetzt als Anwesen wird davon nicht getroffen. Das Jetzt, das keine Klasse ist, ist das an der Faser.
\item Erschlossen: Die Richtungen des Raumes kommen nicht aus dem Raum, sondern von einem Bewegten; die Dimensionszahl aus der Wirkung. Ob das Bewegte der Zeit zuzurechnen ist, bleibt bei Fink bestritten.
\item Erschlossen: Das Zeitmaß setzt ein Beharrliches voraus, aber kein Raummaß; das Raummaß setzt das Zeitmaß und ein Beharrliches voraus.
...
\item Erschlossen: Baumanns Ich-Dauer, Reichenbachs ewiges Jetzt und Hegels Ich = Ich berühren dasselbe; Reichenbach legt es beiseite.
...
\item Offen: Finks Gleichursprünglichkeit von Räumen und Zeitigen; mit den drei Asymmetrien verträglich, nicht widerlegt.
